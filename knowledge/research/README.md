...
| [mrz-geometric-elimination.md](mrz-geometric-elimination.md) | Vendored OCR-B geometry and existing MRZ repair constraints | Treat the fixed grid, closed alphabet, glyph geometry, and check digits as eliminators that can localise ambiguity before a recogniser guesses. Font geometry is observed; its effect on real recognition remains a measurement plan. |

...
| **[benchmarks/](benchmarks/)** | Methodology, metric definitions, and dated sweep results — including rejected candidates; the pipeline map is [`benchmarks/PIPELINE.md`](benchmarks/PIPELINE.md). The dated log itself, with a generated index, lives in [`benchmarks/FINDINGS.md`](benchmarks/FINDINGS.md). |

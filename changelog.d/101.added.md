- **Tier-2 fields that contradict a checksum-verified MRZ structural read are now flagged.**
  ...
  as `MULLER`, `MUELLER`, or `MUXXER` is never a false positive). A disagreement raises a new

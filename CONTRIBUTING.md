...
Per-crate responsibilities are kept in one place, not duplicated here — see
[`ARCHITECTURE.md` §13.1](knowledge/ARCHITECTURE.md#131-crate-responsibilities) for the
contract-level table and the "Repository layout" section of [README.md](README.md) for the
directory tree.
